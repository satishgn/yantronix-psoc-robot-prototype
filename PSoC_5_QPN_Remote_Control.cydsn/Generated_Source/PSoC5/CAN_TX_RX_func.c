...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgJ1VRxData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgJ1VRxData(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_J1VRxData_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_J1VRxData_CALLBACK
                    CAN_SendMsg_J1VRxData_Callback();
                #endif /* CAN_SEND_MSG_J1VRxData_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgJ1VRyData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgJ1VRyData(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_J1VRyData_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_J1VRyData_CALLBACK
                    CAN_SendMsg_J1VRyData_Callback();
                #endif /* CAN_SEND_MSG_J1VRyData_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgJ1SWData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgJ1SWData(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_J1SWData_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_J1SWData_CALLBACK
                    CAN_SendMsg_J1SWData_Callback();
                #endif /* CAN_SEND_MSG_J1SWData_CALLBACK */
...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgLED1Data
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgLED1Data(void) 
    {
        /* `#START MESSAGE_LED1Data_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_LED1Data_CALLBACK
            CAN_ReceiveMsg_LED1Data_Callback();
        #endif /* CAN_RECEIVE_MSG_LED1Data_CALLBACK */
