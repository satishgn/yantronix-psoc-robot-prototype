...
static PWM_M1_BACKUP_STRUCT PWM_M1_backup;
...
{
    if(0u != (PWM_M1_BLOCK_CONTROL_REG & PWM_M1_MASK))
    {
        PWM_M1_backup.enableState = 1u;
    }
    else
    {
        PWM_M1_backup.enableState = 0u;
    }
...
void PWM_M1_Wakeup(void)
{
    ...
    if(0u != PWM_M1_backup.enableState)
    {
        PWM_M1_Enable();
    }
}
