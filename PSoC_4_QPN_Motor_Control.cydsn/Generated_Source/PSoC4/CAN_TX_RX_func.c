...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgLED1Data
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgLED1Data(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_LED1Data_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_LED1Data_CALLBACK
                    CAN_SendMsg_LED1Data_Callback();
                #endif /* CAN_SEND_MSG_LED1Data_CALLBACK */
...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgJ1VRxData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgJ1VRxData(void) 
    {
        /* `#START MESSAGE_J1VRxData_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_J1VRxData_CALLBACK
            CAN_ReceiveMsg_J1VRxData_Callback();
        #endif /* CAN_RECEIVE_MSG_J1VRxData_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_ReceiveMsgJ1VRyData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgJ1VRyData(void) 
    {
        /* `#START MESSAGE_J1VRyData_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_J1VRyData_CALLBACK
            CAN_ReceiveMsg_J1VRyData_Callback();
        #endif /* CAN_RECEIVE_MSG_J1VRyData_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgJ1SWData
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgJ1SWData(void) 
    {
        /* `#START MESSAGE_J1SWData_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_J1SWData_CALLBACK
            CAN_ReceiveMsg_J1SWData_Callback();
        #endif /* CAN_RECEIVE_MSG_J1SWData_CALLBACK */
