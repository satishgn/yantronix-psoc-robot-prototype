...
static PWM_M2_BACKUP_STRUCT PWM_M2_backup;
...
{
    if(0u != (PWM_M2_BLOCK_CONTROL_REG & PWM_M2_MASK))
    {
        PWM_M2_backup.enableState = 1u;
    }
    else
    {
        PWM_M2_backup.enableState = 0u;
    }
...
void PWM_M2_Wakeup(void)
{
    ...
    if(0u != PWM_M2_backup.enableState)
    {
        PWM_M2_Enable();
    }
}
